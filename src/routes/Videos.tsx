...
const allVideos = [
  ...
  {
    id: 4,
    title: "United FC Kodagu vs Misaka United FC",
    youtube_url: "https://www.youtube.com/watch?v=X2JYC_8Syf8",
    thumbnail: "https://img.youtube.com/vi/X2JYC_8Syf8/hqdefault.jpg",
    round: "Round 3",
    date: "04-Aug-2025",
  },
  {
    id: 5,
    title: "Kemp FC vs United FC Kodagu",
    youtube_url: "https://www.youtube.com/live/qmO75nYrfH0?si=bD-7sZVUP2DPMO3Q",
    thumbnail: "https://img.youtube.com/vi/qmO75nYrfH0/hqdefault.jpg",
    round: "Round 2",
    date: "01-Aug-2025",
  },
  {
    id: 6,
    title: "United FC Kodagu vs Kickstart FC Karnataka",
    youtube_url: "https://www.youtube.com/watch?v=fg04n_lbbxo",
    thumbnail: "https://img.youtube.com/vi/fg04n_lbbxo/hqdefault.jpg",
    round: "Round 1",
    date: "28-Jul-2025",
  },
];
...
const Videos = () => {
  return (
    <div className="h-fit px-4 sm:px-8 md:px-[5vw] py-8 md:py-12 flex flex-col ">
      ...
      <div className="h-fit lg:min-h-[300px] md:min-h-[400px] w-full grid grid-cols-1 md:grid-cols-3 gap-6 place-items-stretch items-stretch md:gap-12">
        {allVideos.map((item) => (
          <a
            key={item.id}
          ...
          >
            ...
            <div className="w-full mt-auto h-[2px] shrink-0 bg-zinc-300  mb-4"></div>
